...
class EnrichmentResult:
    ...
    topics: Optional[TopicClassificationResult] = None
...
{{
    ...
    async def _llm_topic_classification(self, text: str) -> Optional[Dict[str, Any]]:
...
Respond with just the topic name and confidence (0-1)."""
    ...
    async def extract_keywords(self, text: str, max_keywords: int = 10) -> List[str]:
        ...
        stop_words = {
            ...
            'many', 'than', 'them', 'these', 'would', 'there', 'their',
            'what', 'said', 'each', 'which', 'will', 'about', 'could',
            'this', 'with', 'from', 'they', 'been', 'have', 'were',
            'more', 'very', 'when', 'come', 'made', 'find', 'made',
            'part', 'over', 'such', 'take', 'only', 'think', 'know',
            'just', 'first', 'also', 'after', 'back', 'other', 'many'
        }
