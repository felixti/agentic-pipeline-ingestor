...
class PluginRegistry:
    ...
    def get_source(self, plugin_id: str) -> Optional[SourcePlugin]:
    ...
    def get_parser(self, plugin_id: str) -> Optional[ParserPlugin]:
    ...
    def get_destination(self, plugin_id: str) -> Optional[DestinationPlugin]:
